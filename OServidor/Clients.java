    ...
    public void run()
    {
        ...
        while(keepListening)
        {
            try
            {
                ...
                System.out.println("Servidor está recebendo   "+ message);
                ...
                if(header.equalsIgnoreCase("login"))
                {
                    ...
                    clientListener.clientStatus(name+": está conectado , IPaddress :"+client.getInetAddress()+"  ,Porta :"+client.getPort());
                }
